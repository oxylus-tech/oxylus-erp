<template>
    <v-expansion-panel :title="t(Email, 2)" value="emails"
    ...
    <v-expansion-panel :title="t(Phone, 2)" value="phones"
    ...
    <v-expansion-panel :title="t(Address, 2)"
    ...
    <v-expansion-panel :title="t(BankAccount, 2)"
